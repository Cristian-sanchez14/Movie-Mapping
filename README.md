...
## Overview General Assembly

We built a simple movie application that renders movies and genres to practice mapping over components and passing data with props. Creating 2 new components to accomplish this.

## What We're Building

<img src="./public/movie.png" alt="example" width="100%" />
...
- PR must be submitted utilizing these guidelines: [PR Guidelines](https://github.com/SEI-R-9-19/template_pull_request)
